...
export const GET_POST_BY_SLUG = `*[_type == "post" && slug.current == $slug] {mainImage, title, previewDescription, _createdAt, _updatedAt, body, "categories": categories[]->title}[0]`
